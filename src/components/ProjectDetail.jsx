...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.github || "https://github.com/rafliandreansyah",
      };
  ...
  const projectUrl = `https://rafliportfolio.vercel.app/project/${toSlug(project.title)}`;

  return (
    <>
      <Helmet>
        <title>{project.title} — Rafli Andreansyah</title>
        <meta
          name="description"
          content={
            project.description
              ? project.description.slice(0, 155)
              : `Project ${project.title} oleh Rafli Andreansyah — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.title} — Rafli Andreansyah`}
        />
        <meta
