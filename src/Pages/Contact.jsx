...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl =
        "https://formsubmit.co/rafliandreansyah957@gmail.com";
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] ">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have a question or need a hand with a project? Send me a message, and
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Ready to start a conversation? Send me a message and let’s
                  connect.
                </p>
              </div>
