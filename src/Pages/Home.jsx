...
const SOCIAL_LINKS = [
  {
    icon: Github,
    link: "https://github.com/rafliandreansyah",
    label: "GitHub Profile",
  },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/rafli-andreansyah-86299217a/",
    label: "LinkedIn Profile",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/rafliandrean_/?hl=id",
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Rafli Andreansyah — Mobile Developer</title>
        <meta
          name="description"
              ...
              >
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p
                    ...
                    data-aos-delay="1000"
                  >
                    Building innovative digital solutions through the
                    development of functional and user-friendly mobile apps
                    (Android, Flutter, React Native) and websites (ReactJS).
                  </p>
