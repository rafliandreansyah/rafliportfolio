...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Building simple, cost-effective technology that delivers real impact
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I don’t just write code; I provide the technical solutions that
              companies need to scale. My focus is on solving business
              challenges by building high-performance, cost-effective digital
              products. I bridge the gap between complex organizational problems
              and streamlined, user-centric technology that is easy to adopt and
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Code is the medium; solving real-world problems is the
                mission."
              </blockquote>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/file/d/14pBEIU1bAoGjExH27UXPHXCj-fPLYkdE/view?usp=sharing"
